...
import { IonContent, IonPage, IonText, IonItem, IonLabel, IonInput, IonButton, IonCheckbox, IonSpinner, IonModal, IonList  } from '@ionic/vue';
...
export default defineComponent({
    name: 'LoginPage',
    components: { IonContent, IonPage, IonText, IonItem, IonLabel, IonInput, IonButton, IonCheckbox, IonSpinner, BackButton, IonModal, IonList },
    data() {
        return{
            loginInput: "",
            password: "",
